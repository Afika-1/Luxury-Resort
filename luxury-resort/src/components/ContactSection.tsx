...
export function ContactSection() {
  ...
  const validateField = (id, value) => {
    if ((id === 'firstName' || id === 'lastName' || id === 'message') && !value.trim()) {
      return 'Required';
    }
    if (id === 'email') {
  ...
  const inputClass = (id) =>
    `w-full h-12 px-4 bg-slate-700/50 border ${errors[id] ? 'border-red-500' : 'border-slate-600/40'} focus:border-amber-400 focus:ring-2 focus:ring-amber-400/20 focus:outline-none rounded-xl transition-all duration-200 text-white placeholder-slate-400`;
  const textInputClass=(id) =>`w-full p-4 bg-slate-700/50 border ${errors[id] ? 'border-red-500' : 'border-slate-600/40'} focus:border-amber-400 focus:ring-2 focus:ring-amber-400/20 focus:outline-none rounded-xl resize-y  transition-all duration-200 text-white placeholder-slate-400`;
  return (
    <>
          ...
          <div className="grid grid-cols-1 xl:grid-cols-3 gap-8">
            ...
            <div className="space-y-6">
              <div className="bg-slate-800/40 backdrop-blur-md border border-slate-600/30 shadow-2xl hover:shadow-amber-500/10 hover:shadow-2xl transition-all duration-300 rounded-xl">
                <div className="p-6">
                  <div className="flex items-center space-x-4">
                    <div className="bg-gradient-to-br from-amber-100 to-amber-200 p-3 rounded-2xl shadow-lg flex-shrink-0">
                      <MapPin className="text-amber-600" size={20} />
                    </div>
                    <div className="flex-1 min-w-0">
                      <h3 className="text-lg mb-2 text-white" style={{
                        fontFamily: 'Playfair Display, serif',
                        fontWeight: '600'
                      }}>Location</h3>
                      <p className="text-slate-300 leading-relaxed text-sm" style={{
                        fontFamily: 'Crimson Text, serif'
                      }}>
              ...
              <div className="bg-slate-800/40 backdrop-blur-md border border-slate-600/30 shadow-2xl hover:shadow-blue-500/10 hover:shadow-2xl transition-all duration-300 rounded-xl">
                <div className="p-6">
                  <div className="flex items-center space-x-4">
                    <div className="bg-gradient-to-br from-blue-100 to-blue-200 p-3 rounded-2xl shadow-lg flex-shrink-0">
              ...
              <div className="bg-slate-800/40 backdrop-blur-md border border-slate-600/30 shadow-2xl hover:shadow-emerald-500/10 hover:shadow-2xl transition-all duration-300 rounded-xl">
                <div className="p-6">
                  <div className="flex items-center space-x-4">
                    <div className="bg-gradient-to-br from-emerald-100 to-emerald-200 p-3 rounded-2xl shadow-lg flex-shrink-0">
              ...
              <div className="bg-slate-800/40 backdrop-blur-md border border-slate-600/30 shadow-2xl hover:shadow-purple-500/10 hover:shadow-2xl transition-all duration-300 rounded-xl">
                <div className="p-6">
                  <div className="flex items-center space-x-4">
                    <div className="bg-gradient-to-br from-purple-100 to-purple-200 p-3 rounded-2xl shadow-lg flex-shrink-0">
              ...
              <div className="bg-gradient-to-br from-slate-700/60 to-slate-800/60 backdrop-blur-md border border-slate-500/30 shadow-2xl rounded-xl">
                <div className="p-6 text-center">
                  <h4 className="text-lg mb-3 text-white" style={{
                    fontFamily: 'Playfair Display, serif',
                    fontWeight: '600'
                  }}>King Shaka International Airport</h4>
                  <p className="text-3xl text-transparent bg-gradient-to-r from-amber-400 to-amber-600 bg-clip-text mb-2" style={{
                    fontFamily: 'Playfair Display, serif',
                    fontWeight: '700'
                  }}>75 km</p>
                  <p className="text-slate-300 text-sm" style={{
                    fontFamily: 'Crimson Text, serif'
                ...
                <div className="p-10">
                  ...
                  <div className="space-y-1">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div>
                        <label htmlFor="firstName" className="block mb-1 text-slate-300 font-medium" style={{
                          fontFamily: 'Crimson Text, serif'
                        }}>First Name</label>
                        <input
                          id="firstName"
                          ...
                          onMouseLeave={() => setErrors(prev => ({ ...prev, firstName: validateField('firstName', formData.firstName) }))}
                          className={inputClass('firstName')} />
                      </div>
                      <div>
                        <label htmlFor="lastName" className="block mb-1 text-slate-300 font-medium" style={{
                          fontFamily: 'Crimson Text, serif'
                        }}>Last Name</label>
                        <input
                          id="lastName"
                          ...
                          onChange={handleInputChange}
                          onMouseLeave={() => setErrors(prev => ({ ...prev, lastName: validateField('lastName', formData.lastName) }))}
                          placeholder="Enter your last name"
                          className={inputClass('lastName')} />
                      </div>
                    </div>
                    <div>
                      <label htmlFor="email" className="block mb-1 text-slate-300 font-medium" style={{
                        fontFamily: 'Crimson Text, serif'
                      }}>Email</label>
                      <input
                        id="email"
                        ...
                        onMouseLeave={() => setErrors(prev => ({ ...prev, email: validateField('email', formData.email) }))}
                        required
                    ...
                    <div>
                      <label htmlFor="phone" className="block mb-1 text-slate-300 font-medium" style={{
                        fontFamily: 'Crimson Text, serif'
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div>
                        <label htmlFor="checkin" className="block mb-1 text-slate-300 font-medium" style={{
                          fontFamily: 'Crimson Text, serif'
                        }}>Check-in Date</label>
                        <input
                          id="checkin"
                      ...
                      <div>
                        <label htmlFor="checkout" className="block mb-1 text-slate-300 font-medium" style={{
                          fontFamily: 'Crimson Text, serif'
                    ...
                    <div>
                      <label htmlFor="message" className="block mb-1 text-slate-300 font-medium" style={{
                        fontFamily: 'Crimson Text, serif'
                      }}>Message</label>
                      <textarea
                        id="message"
                        ...
                        onChange={handleInputChange}
                        onMouseLeave={() => setErrors(prev => ({ ...prev, message: validateField('message', formData.message) }))}

                        placeholder="Tell us about your planned stay, special requests, or any questions you may have..."
                        // className="w-full p-4 bg-slate-700/50 border border-slate-600/40 focus:border-amber-400 focus:ring-2 focus:ring-amber-400/20 focus:outline-none rounded-xl resize-y transition-all duration-200 text-white placeholder-slate-400"
className={textInputClass('message')}
                      />
                    </div>
