...
//           <div className="flex-shrink-0">
//             <a href="/" className="text-xl font-medium" aria-label="Coastal Beach Resort home">
...
//           {/* Book Now Button (Desktop) - wrapped with BookingForm to open dialog */}
//           <div className="hidden md:block">
//             <BookingForm>
//               <Button>
//                 Book Now
...
//         {/* Mobile Navigation */}
//         {isMenuOpen && (
//           <div className="md:hidden" role="dialog" aria-label="Mobile navigation">
//             <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3 bg-white border-t border-black/10">
//               {navItems.map((item) => (
//                 <a
//                   key={item.name}
