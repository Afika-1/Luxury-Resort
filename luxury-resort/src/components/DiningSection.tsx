    ...
    <section id="dining" className="py-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl mb-4">Dining Experience</h2>
        ...
        <div className="bg-gray-100 rounded-lg p-8 max-w-4xl mx-auto ">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-white p-6 rounded-lg shadow-sm">
              ...
              <p className="text-sm mb-2">"Breakfast was amazing, friendly staff and chefs. They even had an event with free tickets and free food. The event was massive!!"</p>
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm">
              ...
              <p className="text-sm mb-2">"Friendly staff. Great food. Exceptional facilities."</p>
              <p className="text-xs text-muted-foreground">- Ntobeko, South Africa</p>
            </div>
          </div>
        </div>
      </div>
